...
The first thing we do is set up the query, which counts the number of rows in our newly saved table in our database. By using `dbGetQuery()`, we can combine 
...
Let's ask a simple question. How many 
