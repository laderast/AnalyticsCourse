---
title: 'Weeks 4 and 5: SQLite: Self Joins/Working with Dates'
author: "Ted Laderas"
date: "`r Sys.Date()`"
...
First, let's write a new table into our database. We'll call it `index_query`. We'll use `dbWriteTable()` to save it as a table into our database, called `index_query`. Note we have to name the table using the `name` argument:
...
## Week 4-5 Assignment (5 points)

Please refer to the `week45submission.Rmd` file in the workspace. 