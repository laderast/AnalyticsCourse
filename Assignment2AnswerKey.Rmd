...
dbWriteTable(con, "DiaCompCo", DiaCompCo)
...
dbWriteTable(con, "MCComorbid", myoScores)
...
sqlStatement <- "SELECT a.*, m.MyoComorbid, d.DCComorbid, 
                (m.MyoComorbid + d.DCComorbid) as CScore FROM analytic as a, 
                DiaCompComorbid as d, 
                MCComorbid as m WHERE a.patientID = m.patientid AND
...
Now we can summarize our LACE score by using another 
