...
**QUESTION**: How many `setosa` samples are there in the iris dataset? 

**QUESTION**: What is the maximum `Sepal.Length`? What units is it in? (Hint: look at the help file for the dataset again.)
...
**QUESTION**: How many rows are there total?

##For more information

Please refer to R-Bootcamp, Modules 1 and 2 for more information on the Rstudio software and `data.frames`.
