...
Download the [synthetic dataset here](https://ohsu.box.com/s/xqios7ryxzfj7ztgc1y77hz68c94gni9), unzip it, and place the folder somewhere easily accessible (the Desktop is fine for now). 
...
Load in the `patient_encounter.txt` file into R, and confirm that you loaded it correctly. How many `No shows` were there in the dataset? (Look in the outcome field). If we want to count the number of readmissions, would we want patients with these values?