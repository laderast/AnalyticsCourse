...
Download the [synthetic dataset here](https://sakai.ohsu.edu/access/content/group/BMI-569-1-AI-Su16/modules/RawSyntheticData.zip), unzip it, and place the folder somewhere easily accessible (the Desktop is fine for now). 
...
If you do this, you can just click on the .Rproj file it generates and have everything easily accessible within the folder. R will able to "see" all of the data files in this folder.
...
##This Week's Assignment (optional but helpful)
