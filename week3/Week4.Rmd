...
Try running the INNER JOIN query above, but using SELECT COUNT(*) instead of SELECT *. How many rows did this query return?
...
table(collectedResult$highRiskER, collectedResult$outcome)
```
