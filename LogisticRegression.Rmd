...
Looking at the coefficient for `LScore`, this means that for a 1 unit increase in `LScore`, the odds(Readmit score) is 1 increases by `r 100 * expCoefs["LScore"] - 100` percent. 
