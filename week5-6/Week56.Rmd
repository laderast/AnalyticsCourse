...
This is the final assignment. After this assignment, you should be able to conduct the queries required for the prework assignment.
...
```{r echo=FALSE}
tab <- read.delim("RawSyntheticData/peh_example.txt")
tab[1:10,]
```
